...
_.getLangFromDomain = function(host) {
	if(host.indexOf('.') === 2) {
...
_.toObject =function (obj) {
	if(typeof(obj) === 'string') {
		if(!$.trim(obj)) return null;
	}
	if (typeof(obj) !== 'object') obj = JSON.parse(obj);
	return obj;
}
...
_.dataURLtoBlob = function (dataURL) {
	...
	return new Blob([intArray.buffer], {type: mime_type, encoding: 'utf-8'});
}
